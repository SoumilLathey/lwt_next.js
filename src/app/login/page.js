...
import { Mail, Lock, ShieldAlert, ArrowRight, ArrowLeft } from 'lucide-react';
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        localStorage.setItem('lwt_user', JSON.stringify(data.user));
    ...
    <div style={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', background: 'var(--bg-body)' }}>
      ...
      <main style={{ 
        ...
        <div style={{ 
          ...
          <div style={{ textAlign: 'center', marginBottom: '32px' }}>
            <h1 style={{ fontSize: '28px', fontWeight: 800, color: 'var(--heading-color)', fontFamily: 'Outfit, sans-serif', marginBottom: '8px' }}>Welcome Back</h1>
            <p style={{ color: 'var(--text-muted)', fontSize: '14px', margin: 0 }}>Login to access your customer dashboard</p>
          </div>
          ...
          <div style={{ 
            ...
            <p style={{ color: 'var(--text-muted)', margin: 0 }}>
              ...
              <Link href="/signup" style={{ color: 'var(--color-primary)', fontWeight: 600, textDecoration: 'underline' }}>Sign up here</Link>
            </p>
            <p style={{ color: 'var(--text-muted)', margin: 0 }}>
              Are you an employee?{" "}
              <Link href="/employee/login" style={{ color: 'var(--color-secondary)', fontWeight: 700, textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '4px', justifyContent: 'center' }}>
